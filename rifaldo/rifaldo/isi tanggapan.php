...
<body style="background:grey">
  ...
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      <li class="nav-item">
        <a class="nav-link text-dark" href="data masyrakat.php">data masyrakat</a>
      </li>
      <li class="nav-item">
...
<div style="padding: 10px;">
        ...
        <div class="card my-6">
            ...
            <h2 class="mb-3 mt-4 text-center" style="color:rgb(61, 61, 61);">isi tanggapan</h2>
            <div class="container mt-2">
            <div class="mb-3">
              <div>
              <div class="mb-3 text-center mt-3 ">
                id tanggapan : 
                <input class="rounded-3 form-control" type="text" name="id_tanggapan" style="width: 400px;margin:auto">
              </div>
              <div class="mb-3 text-center mt-3 ">
                id pengaduan : 
                <input class="rounded-3 form-control" type="" name="id_pengaduan" style="width: 400px;margin:auto">
              </div>
              <div class="mb-3 text-center mt-3 ">
                tanggal pengaduan : 
              ...
              <div class="mb-3 text-center mt-3 ">
                tanggapan: 
                <input class="rounded-3 form-control" type="text" name="tanggapan" style="width: 400px;margin:auto">
              </div>
              <div class="mb-3 text-center mt-3 ">
                id petugas: 
                <input class="rounded-3 form-control" type="text" name="id_petugas" style="width: 400px;margin:auto">
              </div>
